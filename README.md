...
| --- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| 🚀  | **Project Documentation**                                                        | Onboarding, setup guides, and core workflows                      |
| 🤖  | **AI Editing Workflow**                                                         | Prompting, iterating, inspecting changes, and version management  |
| 🛠️  | **Developer Tools**                                                             | Elements, Console, and Code panels for precise debugging          |
| 💰  | **Account & Billing**                                                           | Plans, usage, and what's included                                 |
